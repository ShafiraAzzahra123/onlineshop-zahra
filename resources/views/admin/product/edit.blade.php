                    ...
                    <form action="/admin/product/update/{{$product->id}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                          ...
                          <div class="mb-3">
                            ...
                            <input name="price_product" type="text" class="form-control" value="{{$product->price_product}}">
                          </div>
                          <div class="mb-3">
                            <label class="form-label">Detail Produk</label>
                            <input name="detail_product" type="text" class="form-control" value="{{$product->detail_product}}">
                          </div>
                          <div class="mb-3">
                            <label class="form-label">Stok</label>
                            <input name="stock_product" type="number" class="form-control" value="{{$product->stock_product}}">
                          </div>
                          <div class="mb-3">
